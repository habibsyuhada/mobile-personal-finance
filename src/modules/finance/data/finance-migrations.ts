// Migrasi modul Keuangan. Dijalankan oleh runner migrasi platform dengan versi
// ber-namespace (`schema_version.finance`). DDL idempoten (IF NOT EXISTS).
import type { ModuleMigration } from '@/platform/types';

export const FINANCE_MIGRATIONS: ModuleMigration[] = [
  {
    version: 1,
    statements: [
